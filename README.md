...
|:------:|:------:|:-----|
| ⏱️ Request rate | 20/min | Per IP per minute |
| 🔄 Concurrent | 2 | Max concurrent requests |
| ⏳ Interval | 5 sec | Minimum interval between requests |
| 💬 Follow-up | 10/day | Per conversation per day |
...
├── 📚 lib/                    # Utilities
│   ├── ai/                    # AI providers
│   ├── calculations/          # Divination calculations
│   ├── prompts/               # AI prompts
...
<details>
<summary><b>Q: How to change AI provider?</b></summary>

Modify `AI_PROVIDER` in `.env.local` and restart the service.
</details>

<details>
<summary><b>Q: Which AI models are supported?</b></summary>

Supports DeepSeek, Kimi, GLM-4, Anthropic, etc. Free to switch.
</details>

<details>
<summary><b>Q: Is mobile supported?</b></summary>

Fully supported! Responsive design works perfectly on phones, tablets, and computers.
</details>

<details>
<summary><b>Q: How to deploy to server?</b></summary>

```bash
npm run build
npm start
```
Or deploy using Vercel, Railway, etc.
</details>
